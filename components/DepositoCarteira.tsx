...
export default function DepositoCarteira({ onFechar, onSucesso }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[60] flex items-center justify-center p-4">
      <div className="bg-zinc-900 border border-yellow-500/20 rounded-xl w-full max-w-sm p-5 relative max-h-[90vh] overflow-y-auto">
        <button
          onClick={onFechar}
